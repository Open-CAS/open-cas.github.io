...
weight: 10
toc: false
aliases: ["/getting_started_open_cas_linux.html"]
---
...
> Instructions are available [here](/open-cas-linux/installing/#creating-rpmdeb-packages)

For complete guide to Open CAS Linux please refer to the [**Admin Guide**](/open-cas-linux/)
