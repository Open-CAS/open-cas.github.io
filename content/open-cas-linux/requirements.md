...
weight: 30
aliases: ["/guide_system_requirements.html"]
---
...
| File Systems     | The following file systems are supported for primary storage or core storage: <ul><li>ext3 (limited to 16TiB volume size). This is an ext3 file system limitation</li><li>ext4</li><li>xfs</li></ul>                                                                                                                  |
| Software         | The following prerequisite software must be installed prior to Open CAS Linux installation:  <ul><li>sed</li><li>make</li><li>gcc</li><li>kernel-devel</li><li>kernel-headers</li><li>python3</li><li>lsblk</li><li>argparse (python module)</li><li>elfutils-libelf-devel</li></ul>                         |
