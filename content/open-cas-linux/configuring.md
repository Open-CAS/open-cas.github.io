---
title: "Configuring CAS"
weight: 50
aliases: ["/guide_configuring.html"]
---
...
different command line options, see the section [Configuration Tool Details](/open-cas-linux/tool-reference/).
...
utility, see the section [Configuration Tool Details](/open-cas-linux/tool-reference/).
...
If the Open CAS Linux module is not loaded, follow the [installation](/open-cas-linux/installing/)
...
3.  To take advantage of the new TRIM functionality, the file system must be
    mounted with additional options. Please see the [Trim Support](/open-cas-linux/advanced-options/#trim-support) section for further details.
