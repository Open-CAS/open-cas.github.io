...
weight: 90
aliases: ["/guide_advanced_options.html"]
---
...
following a clean restart. See section [**Stopping Cache Instances**](/open-cas-linux/running/#stopping-cache-instances) for details on stopping
Open CAS Linux.
...
[**Configuring CAS**](/open-cas-linux/configuring/) for further details) a physical
