...
At the core of Open CAS is the Open CAS Framework (OCF). To build upon OCF and in order to provide complete caching solutions, Open CAS also provides adapter implementations for Linux operating systems and for SPDK applications.  See the sections [Open CAS Linux](/introduction/#open-cas-linux) and [SPDK Block Device](/introduction/#storage-performance-development-kit-ocf-block-device) below for more information.  
...
Visit the [What is OCF](/concepts/what-is-ocf/) and [OCF Quick Setup](/ocf/quick-start/) pages for more information.
...
Visit the [Open CAS Linux Quick Setup](/open-cas-linux/quick-start/) and [Open CAS Linux Admin Guide](/open-cas-linux/introduction/) pages for more information.
...
Visit the [Storage Performance Development Kit](https://spdk.io/) and [SPDK Quick Setup](/spdk/) pages for more information.
