...
weight: 50
toc: false
aliases: ["/cache_line.html"]
---

A **cache line** is the smallest portion of data that can be mapped
into a [**cache**](/concepts/cache/). Every mapped **cache line** is
...
- When the **cache line** is being [**evicted**](/concepts/cache-operations/).
- When the **core** pointed to by the *core id* is being
  [**removed**](#).
- When the **core** pointed to by the *core id* is being
  [**purged**](/concepts/cache-operations/).
...
- During I/O request when a
  [**cache mode**](/concepts/cache-configuration/#cache-mode) which may perform
