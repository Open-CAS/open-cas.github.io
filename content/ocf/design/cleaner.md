...
weight: 30
toc: false
aliases: ["/cleaner.html"]
---

Cleaner is a necessary feature of any caching solution. In the end, if there is
[**dirty data**](/concepts/cache-line/#valid-and-dirty-bits), it must always be 
[**cleaned**](/concepts/cleaning/) by flushing the dirty data from the cache to a 
backing storage.
...
different [**cleaning policies**](/ocf/design/cleaner/#cleaning-policies). 
...
cleaning policy. The [**ALRU**](/ocf/design/cleaner/#alru---approximately-least-recently-used)
