 ...
 * **seq-threshold** - the amount of data after which an I/O request is handled by [**Pass Through cache mode**](/concepts/cache-configuration/#pass-through).
[KiB]
