...
weight: 20
toc: false
aliases: ["/ocf_io_engines.html"]
---

Open CAS implements several [**cache modes**](/concepts/cache-configuration/), 
...
* [**Generic Read**](/ocf/design/io-engines/#generic-read)
* [**Write Through**](/ocf/design/io-engines/#write-through-wt)
* [**Write Back**](/ocf/design/io-engines/#write-back-wb)
* [**Write Around**](/ocf/design/io-engines/#write-around-wa)
* [**Pass Through**](/ocf/design/io-engines/#pass-through-pt)
* [**Write Invalidate**](/ocf/design/io-engines/#write-invalidate-wi)
* [**Write Only**](/ocf/design/io-engines/#write-only-wo)
* [**Backfill**](/ocf/design/io-engines/#backfill-bf)
* [**Fast**](/ocf/design/io-engines/#fast)
* [**Direct To Core**](/ocf/design/io-engines/#direct-to-core-d2c)
* [**Invalidate**](/ocf/design/io-engines/#invalidate)
* [**Discard**](/ocf/design/io-engines/#discard)
* [**Ops Engine**](/ocf/design/io-engines/#ops-engine)
...
a [**cleaner**](/ocf/design/cleaner/) is invoked to clean the data, i.e. flush the dirty
...
from the core device. Additionally, a [**Backfill**](/ocf/design/io-engines/#backfill-bf)
...
[**Generic Read**](/ocf/design/io-engines/#generic-read) engine, read operations 
will be accelerated.
...
[**Write Invalidate (WI)**](/ocf/design/io-engines/#write-invalidate-wi) engine 
...
This data is then periodically cleaned by the [**cleaner**](/concepts/cleaning/),
i.e. flushed to a core device.

The request may be handled by [**Write Invalidate**](/ocf/design/io-engines/#write-invalidate-wi) 
engine if it cannot be handled by Write Back method, thus bypassing the cache.

This engine is used by the [**Write Back cache mode**](/concepts/cache-configuration/#write-back)
...
[**Write Only cache mode**](/concepts/cache-configuration/#write-only), where cache 
is used as an accelerated write buffer.

## Write Around (WA)
This engine, provided by *ocf_write_wa()* function, writes the data to the cache
and to the core by executing [**Write Through (WT)**](/ocf/design/io-engines/#write-through-wt) 
...
[**Write Invalidate (WI)**](/ocf/design/io-engines/#write-invalidate-wi) internally.
...
filtered out of cache. See [**write around cache mode configuration**](/concepts/cache-configuration/#write-around)  
...
[**Generic Read**](/ocf/design/io-engines/#generic-read) is performed, effectively
reading the data from the cache.

If some sectors are dirty, a cleaning is performed before reading the data from
a core device.

Used by the [**Pass Through cache mode**](/concepts/cache-configuration/#pass-through).
...
## Backfill (BF)
This engine is used internally by [**Generic Read**](/ocf/design/io-engines/#generic-read)
